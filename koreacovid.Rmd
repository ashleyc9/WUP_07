...
There is a total of 100 men and women each. The females that are alive are 56% of them, while males have 44% alive. Then the males that are dead is a percentage of 64, while females have a percentage fo 36. In the second chart is below the first, shows that there is a percentage of females that is 98.7, while me have a percentage fo 97. The amount of females that are dead are 1.4, while males have 3.
